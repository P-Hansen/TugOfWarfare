...
global.timer = 10;
global.availbleRelics = [guardTowers, cagedUnit, spiderCharm]//brambleSeeds, thunderStone, attackUpgrade, defenceUpgrade, treasureChest, goblinConscripts, crabGuards, HireASquire];
