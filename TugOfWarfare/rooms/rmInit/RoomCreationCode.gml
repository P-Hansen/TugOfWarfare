...
global.timer = 10;
global.availbleRelics = [guardTowers, cagedUnit, berserkerCharm]//blizzardStone, spiderCharm, brambleSeeds, thunderStone, attackUpgrade, defenceUpgrade, treasureChest, goblinConscripts, crabGuards, HireASquire];
