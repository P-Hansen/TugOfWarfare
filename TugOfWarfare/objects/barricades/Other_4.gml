...
if(roomName != "rmWin" and roomName != "rmFactionSelect" and roomName != "rmInit" and roomName != "rmMainMenu"){

	var _y = (50)/global.GRIDSIZE * global.GRIDSIZE;
	...
	var _y = ((room_height-100)/2)/global.GRIDSIZE * global.GRIDSIZE;
	...
	var _y = (room_height-150)/global.GRIDSIZE * global.GRIDSIZE;
