...
draw_sprite_ext(archer, animationSpeed, room_width/2-200, room_height/2-80, -3, 3, 0, c_black, 1);
draw_text(room_width/2-190, room_height/2-180, "?");
...
draw_text(room_width/2-145, room_height/2-65, "?");
