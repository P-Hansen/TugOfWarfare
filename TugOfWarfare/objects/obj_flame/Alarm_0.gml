...
var checkTarget = checkFor_object_xy(x+lengthdir_x(16,dir),y+lengthdir_y(16,dir), flammableClass);
...
if checkTarget
{
	if instance_exists(checkTarget)
	{
		if checkTarget.status != "burning"
		{
			...
			{					
				var flame = instance_create_layer(checkTarget.x,checkTarget.y,"weaponLayer",obj_flame);
